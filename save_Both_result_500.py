...
class DataReader():
    def __init__(self):
        ...
        self.x_test_filepath = 'New_Data\\New_Both_Dataset\\shuffle_both_x_test_dataset.csv'
        self.y_test_filepath = 'New_Data\\New_Both_Dataset\\shuffle_both_y_test_dataset.csv'
...
if __name__ == '__main__':
    ...
    print(x_test.shape)       #(27360, 59, 42, 1)
    print(y_train.shape)      #(109440,)
    print(y_test.shape)       #(27360,)
